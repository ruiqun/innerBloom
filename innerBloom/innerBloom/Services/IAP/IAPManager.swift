...
final class IAPManager {
    ...
    func syncPremiumStatus() async {
        ...
        saveStatusToUserDefaults(status)
        print("[IAPManager] Premium synced: isPremium=\(status.isPremium), isInTrial=\(status.isInTrial)")
    }
