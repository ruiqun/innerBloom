...
enum L10nKey: String, CaseIterable {
    ...
    private var zhHantValue: String {
        ...
        case .loginSubtitle: return "記錄生活，讓 AI 陪你聊聊"
        case .loginPrivacyHint: return "登入後，你的日記資料將與帳號綁定並安全同步到雲端"
    ...
    private var enValue: String {
        ...
        case .loginSubtitle: return "Record your life, chat with AI"
        case .loginPrivacyHint: return "Your diary data will be linked to your account and securely synced to the cloud"
