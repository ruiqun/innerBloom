...
enum L10nKey: String, CaseIterable {
    ...
    case verifyAndSignUp = "verify_and_sign_up"
    case signUpVerifyHint = "sign_up_verify_hint"
    case backToSignUp = "back_to_sign_up"
    case resendCode = "resend_code"
    case resendCodeCountdown = "resend_code_countdown"
    
    case deleteAccount = "delete_account"
    case deleteAccountConfirmTitle = "delete_account_confirm_title"
    case deleteAccountConfirmMessage = "delete_account_confirm_message"
    case deleteAccountSuccess = "delete_account_success"
    case deleteAccountSuccessMessage = "delete_account_success_message"
    ...
    private var zhHantValue: String {
        ...
        case .verifyAndSignUp: return "驗證並完成註冊"
        case .signUpVerifyHint: return "請輸入驗證碼完成註冊。若未收到，請點擊「重新發送驗證碼」"
        case .backToSignUp: return "重新填寫"
        case .resendCode: return "重新發送驗證碼"
        case .resendCodeCountdown: return "%@s 後可重新發送"
        case .deleteAccount: return "刪除帳號"
        case .deleteAccountConfirmTitle: return "確定要刪除帳號嗎？"
        case .deleteAccountConfirmMessage: return "此操作將永久刪除您的帳號及所有儲存的日記、照片與對話記錄，且無法復原。"
        case .deleteAccountSuccess: return "帳號已刪除"
        case .deleteAccountSuccessMessage: return "您的帳號及所有資料已永久刪除，點擊確定將返回登入頁面。"
        case .deleteAccountFailed: return "無法刪除帳號，請稍後再試"
        ...
        case .subscriptionTerms: return "訂閱將自動續訂，除非在到期前至少 24 小時取消。可隨時在 App Store 設定中管理或取消訂閱。"
    ...
    private var enValue: String {
        ...
        case .verifyAndSignUp: return "Verify & Sign Up"
        case .signUpVerifyHint: return "Enter the verification code to complete registration. If not received, tap \"Resend Code\"."
        case .backToSignUp: return "Go Back"
        case .resendCode: return "Resend Code"
        case .resendCodeCountdown: return "Resend in %@s"
        case .deleteAccount: return "Delete Account"
        case .deleteAccountConfirmTitle: return "Delete account?"
        case .deleteAccountConfirmMessage: return "This will permanently delete your account and all stored diaries, photos, and conversations. This cannot be undone."
        case .deleteAccountSuccess: return "Account Deleted"
        case .deleteAccountSuccessMessage: return "Your account and all data have been permanently deleted. Tap OK to return to the login page."
        case .deleteAccountFailed: return "Failed to delete account, please try again later"
        ...
        case .subscriptionTerms: return "Subscription auto-renews unless canceled at least 24 hours before the end of the current period. Manage or cancel anytime in App Store settings."
